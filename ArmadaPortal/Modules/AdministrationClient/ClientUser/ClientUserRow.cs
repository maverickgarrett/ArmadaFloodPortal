...
namespace ArmadaPortal.AdministrationClient.Entities
{
    ...
    [ConnectionKey("Default"), Module("AdministrationClient"), TableName("Users")]
    [DisplayName("Client Users"), InstanceName("User")]
    [ReadPermission(PermissionKeys.Security)]
    [ModifyPermission(PermissionKeys.Security)]
    [LookupScript(Permission = PermissionKeys.Security)]
    
    public sealed class ClientUserRow : LoggingRow, IIdRow, INameRow, IIsActiveRow
    {
        ...
        [DisplayName("FirstName"), Size(100), NotNull, QuickSearch, LookupInclude]
        ...
        [DisplayName("LastName"), Size(100), NotNull, QuickSearch, LookupInclude]
