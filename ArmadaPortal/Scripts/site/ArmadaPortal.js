...
(function (ArmadaPortal) {
    ...
    (function (Flood) {
        ...
        (function (FloodOrderTypeEnum) {
            ...
            FloodOrderTypeEnum[FloodOrderTypeEnum["Migration"] = 100000001] = "Migration";
                ...
                return [
                    {
                        ...
                        click: function () {
                            ...
                            Flood.DocumentService.DocumentImport({
                                ...
                                UploadDocument: _this.form.UploadDocument,
                            }, function (response) {
...
(function (ArmadaPortal) {
    ...
    (function (Flood) {
        var FloodOrderDialog = /** @class */ (function (_super) {
            ...
            FloodOrderDialog.prototype.updateTitle = function () {
                if (this.isEditMode()) {
                    this.dialogTitle = "Order Number " + this.form.OrderNumber.value;
                }
            };
            FloodOrderDialog.prototype.categoryToggler = function (categoryTitle) {
            ...
            FloodOrderDialog.prototype.getToolbarButtons = function () {
                ...
                var letterButton = {
                    ...
                    cssClass: 'export-pdf-button',
                    onClick: function () {
                        Flood.FloodOrderService.CheckIfDeterminationLetterExists({
...
(function (ArmadaPortal) {
    ...
    (function (Flood) {
        var FloodOrderGrid = /** @class */ (function (_super) {
            ...
            FloodOrderGrid.prototype.onViewSubmit = function () {
            ...
            FloodOrderGrid.prototype.set_orderstatusfilter = function (value) {
                this.orderStatusFilter.value = value == null ? '' : value.toString();
            };
            FloodOrderGrid.prototype.hidefilterbar = function () {
