...
namespace MVC
{
    public static class Views
    {
        ...
        public static class AdministrationClient
        {
            ...
            {
                public const string ClientUserIndex = "~/Modules/AdministrationClient/ClientUser/ClientUserIndex.cshtml";
            }
        ...
        public static class Flood
        {
            ...
            {
                public const string DocumentIndex = "~/Modules/Flood/Document/DocumentIndex.cshtml";
            }

            public static class Order
            {
                public const string FloodOrderIndex = "~/Modules/Flood/Order/FloodOrderIndex.cshtml";
                public const string FloodOrderReport = "~/Modules/Flood/Order/FloodOrderReport.cshtml";
            }
        ...
        public static class Shared
        {
            ...
            public const string TopNavigation = "~/Views/Shared/TopNavigation.cshtml";
        }
    }
}
