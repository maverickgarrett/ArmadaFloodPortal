...
using ArmadaPortal.Data.Connect;

namespace ArmadaPortal.Data
{
    public class CrmContext : IDisposable
    {
        ...
        public OrganizationWebProxyClient WebProxyClient
        {
            get
            {
                ...
                if (_organizationWebProxyClient == null)
                {
                    ...
                    _organizationWebProxyClient = new OrganizationWebProxyClient(serviceUri, true);
        ...
        public XrmServiceContext XrmServiceContext 
        {
            get
            {
                Trace.TraceInformation("Get XrmServiceContext");
                if (_XrmServiceContext == null)
                {
                    Trace.TraceInformation("ServiceContext is null");
                    _XrmServiceContext = new XrmServiceContext(WebProxyClient);
                }
